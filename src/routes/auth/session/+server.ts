...
const expiredSessionCookie = "session=; SameSite=Strict; Path=/; HttpOnly; Max-Age=0;";
const expiredRefreshCookie = "refreshSession=; SameSite=Strict; Path=/; HttpOnly; Max-Age=0;";
